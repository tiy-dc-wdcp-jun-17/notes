...
function navigateRushHour( timeOfDay ){
  let message = `The time of day is ${timeOfDay}, `;

  if ((timeOfDay >= 600 && timeOfDay <= 900) ||
      (timeOfDay >= 1600 && timeOfDay <= 1800)) {
    message += "I'm going around the city.";
  } else {
    message += "I'm going through the city.";
  }
...
let factorial = function(num){
  ...
  //
  // 1) Make sure to have a base case.
  // if BASE CASE is reached
  //   return baseValue;
  //
  // 2) Put the function call last.
  // num * factorial(n - 1)
